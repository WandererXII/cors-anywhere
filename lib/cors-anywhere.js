...
function withCORS(headers, request) {
  ...
  var setResponseHeaders = request.corsAnywhereRequestState.setResponseHeaders;
  ...
  Object.keys(setResponseHeaders).forEach(header => {
    headers[header] = setResponseHeaders[header];
  });
...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    setResponseHeaders: {},          // Set these reponse headers.
  ...
  return function(req, res) {
    req.corsAnywhereRequestState = {
      ...
      setResponseHeaders: corsAnywhere.setResponseHeaders
    };
